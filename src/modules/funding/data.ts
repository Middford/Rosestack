...
export const dealStructures: DealStructure[] = [
  ...
  },
  {
    ...
    description: 'Enterprise Investment Scheme. Larger equity rounds with 30% income tax relief for investors. Can raise up to £10M per year (or £20M for knowledge-intensive companies). CRITICAL: Energy generation is an excluded trade under SEIS/EIS. RoseStack\'s battery arbitrage model may be classified as energy generation by HMRC. Obtain HMRC advance assurance before any EIS fundraise. Structure as \'energy management services\' not \'energy generation\'.',
    typicalTermYears: 0,
    typicalRateRange: 'Equity dilution',
    fundingRange: '£250k–£10M per year (£20M for knowledge-intensive companies)',
    pros: [
    ...
    cons: [
      ...
      'Cannot have gross assets over £30M pre-investment / £35M post-investment',
