...
export const lenders: Lender[] = [
  {
    ...
    greenFocused: false,
    contactName: 'Asset Finance Team',
    contactEmail: 'assetfinance@lombard.co.uk',
  ...
  },
  {
    ...
    greenFocused: false,
    contactName: 'Asset Finance Team',
    contactEmail: 'assetfinance@closebrothers.com',
  ...
  },
  {
    ...
    greenFocused: true,
    contactName: 'Enquiries Team',
    contactEmail: 'enquiries@greenfinanceinstitute.co.uk',
  ...
  },
  {
    ...
    minFunding: 1000,
    maxFunding: 2000000,
    typicalRate: '5.0%–8.0% + GGS fee',
    typicalTerm: '1–6 years',
    dscrRequirement: 1.10,
    securityRequired: ['Government guarantee covers 70%', 'Residual personal guarantee may apply'],
  ...
  },
  {
    ...
    personalGuarantee: false,
    greenFocused: true,
    contactName: 'Business Banking Team',
    contactEmail: 'businessbanking@triodos.co.uk',
  ...
  },
  {
    ...
    contactEmail: 'issuers@abundanceinvestment.com',
  ...
  {
    id: 'lender-010',
    name: 'Republic Europe (formerly Seedrs)',
    type: 'equity',
    description: 'UK equity crowdfunding platform, acquired by Republic in 2022 for $100M. Strong investor base interested in impact and sustainability.',
    minFunding: 25000,
    maxFunding: 2000000,
    typicalRate: 'Equity dilution',
    typicalTerm: 'N/A — equity',
  ...
  },
  {
    ...
    name: 'Funding Circle',
    type: 'bank',
    description: 'UK institutional lending platform for SMEs (fully institutional since 2022, FTSE 250, revenue £204M in 2025, extended £2.45bn in credit). Quick decisions, flexible terms. Higher rates but faster than traditional lenders.',
    minFunding: 10000,
    maxFunding: 500000,
  ...
  {
    id: 'lender-013',
    name: 'National Wealth Fund (formerly UK Infrastructure Bank)',
    type: 'public-body',
    description: 'Government institution focused on clean energy infrastructure including battery storage. Deploying up to £5bn/year. Primarily larger projects but partner network includes regional SMEs.',
    minFunding: 250000,
    maxFunding: 50000000,
    typicalRate: 'Government-backed, below market',
    typicalTerm: '5–25 years',
    dscrRequirement: 1.15,
    securityRequired: ['Project-specific security package', 'SPV structure likely required'],
    trackRecordNeeded: 'Proven technology, clear infrastructure case, scalable model',
    personalGuarantee: false,
    greenFocused: true,
    contactName: 'Enquiries Team',
    contactEmail: 'enquiries@nationalwealthfund.org.uk',
    website: 'https://www.nationalwealthfund.org.uk',
    status: 'researching',
    notes: 'Potential for scale phase. Government-backed rates below market. Primarily larger projects but partner network includes regional SMEs.',
  },
];
...
export const dealStructures: DealStructure[] = [
  ...
  },
  {
    ...
    description: 'Seed Enterprise Investment Scheme. First £250k of equity investment qualifies for 50% income tax relief for investors. Hugely attractive for angels. Company must have gross assets of £350k or less at the time of investment. CRITICAL: Energy generation is an excluded trade under SEIS/EIS. RoseStack\'s battery arbitrage model may be classified as energy generation by HMRC. Obtain HMRC advance assurance before any SEIS fundraise. Structure as \'energy management services\' not \'energy generation\'.',
    typicalTermYears: 0,
    ...
    cons: [
      ...
      'Company gross assets must be £350k or less at time of investment',
  ...
  },
  {
    ...
    description: 'Enterprise Investment Scheme. Larger equity rounds with 30% income tax relief for investors. Can raise up to £5M per year (or £12M for knowledge-intensive companies). CRITICAL: Energy generation is an excluded trade under SEIS/EIS. RoseStack\'s battery arbitrage model may be classified as energy generation by HMRC. Obtain HMRC advance assurance before any EIS fundraise. Structure as \'energy management services\' not \'energy generation\'.',
    typicalTermYears: 0,
    typicalRateRange: 'Equity dilution',
    fundingRange: '£250k–£5M per year (£12M for knowledge-intensive companies)',
    pros: [
    ...
    cons: [
      ...
      'Cannot have gross assets over £15M pre-investment / £16M post-investment',
  ...
  },
  {
    ...
    taxBenefits: ['Community organisation tax benefits'],
...
export const investors: Investor[] = [
  {
    ...
    stage: 'contacted',
    contactName: 'Investment Team',
    contactEmail: 'invest@nwangels.co.uk',
  ...
  },
  {
    ...
    stage: 'nda-signed',
    contactName: 'Investment Team',
    contactEmail: 'info@greentechcap.com',
...
export function recommendDealStructure(
  ...
  if (stage === 'pre-revenue') {
    ...
    return {
      ...
      reasoning: 'SEIS for initial equity, then HP for asset finance once first installations prove the model. GGS (Growth Guarantee Scheme) can de-risk the HP facility.',
  ...
  if (stage === 'early-revenue') {
    return {
      ...
      secondary: fundingRequired > 200000
        ...
        : undefined,
      reasoning: 'HP asset finance for battery assets (GGS-backed if needed), supplemented by EIS equity for larger requirements. Revenue track record strengthens HP application.',
